...
<head>
    ...
    <title>Fifteen Celcius &mdash; Food Specialty </title>
    <!-- Bootstrap Core CSS -->
                  ...
                  <div class="carousel-inner">
                    <div class="container">
                      <div class="carousel-caption fadeInUp animated" style="bottom:0;top:200px">
                        <h2 class="display-1" style="color:#fff;">Fifteen Celcius Skylongue</h2>
                        <p class="h2" style="color: #ddd;padding-top:20px;padding-bottom: 20px">A Restaurant from Batu Malang</p>
                      </div>
                    </div>
        ...
        <div id="about">
            <div class="row" style="background-image:url({{ asset('resto/images/wood_1.png')}});">
              ...
              <div class="col-md-6" style="padding:30px 50px;">
                ...
                <p class="lead" style="color:#a99c92;font-weight: 300">Fifteen Celcius The Skylounge merupakan tempat wisata sekaligus tempat makan berupa Kafe dengan konsep unik.Panorama alam persawahan ditambah dengan megahnya pemandangan Gunung Panderman membuat suasana begitu menenangkan. Cafe ini menjadi tempat nongkrong favorit di Batu Malang para pasangan muda. Secara tempatnya yang indah dan romantis, maka sayang jika melewatkan tempat makan enak di Malang ini.</p>
              </div>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    ...
                    <ul>
                        <li style="padding-left: 50px;margin-bottom: 10px">
                            ...
                            Jl. Abdul Gani Atas, Ngaglik, Kec. Batu, <br>  Kota Batu, Jawa Timur 65311
                        </li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-phone" style="position: absolute;left: 20px"></i> (0341)525777</li>
                    </ul>
                </div>
                <div class="col-md-6">
        ...
        <div id="team" class="col-md-12" style="background-image:url({{ asset('resto/images/slide_3.jpg')}});background-size: cover;padding-bottom: 50px">
            <div class="container">
                ...
                <div class="row justify-content-center" style="padding: 15px">
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/Abdul Majid.jpg')}}" title="majid" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/Nadia Fitri.jpeg')}}" title="nadia" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                </div>
            </div>
        </div>
